...
the_fridge: raylib
ifneq (,$(the_fridge_config))
	@echo "==== Building the_fridge ($(the_fridge_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f the_fridge.make config=$(the_fridge_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f the_fridge.make clean
